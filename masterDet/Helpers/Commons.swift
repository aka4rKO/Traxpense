...
class Utilities {
    ...
    static func chooseColor(_ name: String) -> UIColor{
        switch name{
        case "Orange":
            return UIColor(red:1, green:0.6471, blue:0, alpha:1.0).lighter(by: 0)!
        case "Purple":
            return UIColor(red:0.502, green:0, blue:0.502, alpha:1.0).lighter(by: 0)!
        case "Green":
            return UIColor(red:0, green:1, blue:0, alpha:1.0).lighter(by: 0)!
        case "Cyan":
            return UIColor(red:0, green:1, blue:1, alpha:1.0).lighter(by: 0)!
        case "Blue":
            return UIColor(red:0, green:0, blue:1, alpha:1.0).lighter(by: 0)!
        default:
