...
class AddEditExpenseViewController: UIViewController, EKEventEditViewDelegate  {
    ...
    @IBAction func save(_ sender: UIBarButtonItem) {
        if expenseTitleTextField.text == "" {
            Utilities.showInformationAlert(title: "Empty field", message: "Title cannot be empty!", caller: self)
        } else if expenseAmountTextField.text == "" {
            Utilities.showInformationAlert(title: "Empty field", message: "Amount cannot be empty!", caller: self)
        } else {
            ...
            do {
                ...
                let alert = UIAlertController(title: "Success", message: "Expense added!", preferredStyle: .alert)
